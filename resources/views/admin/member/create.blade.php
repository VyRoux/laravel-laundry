    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <form action="{{ route('member.store') }}" method="POST" class="p-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" class="w-full border border-slate-200 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all" placeholder="Nama lengkap pelanggan" required>
            </div>
            ...
            <div>
                ...
                <div class="flex space-x-6">
                    <label class="flex items-center space-x-2">
                        <input type="radio" name="gender" value="laki-laki" class="w-4 h-4 text-indigo-600 focus:ring-indigo-500" required>
                        <span class="text-sm text-slate-700">Laki-laki</span>
                    </label>
                    <label class="flex items-center space-x-2">
                        <input type="radio" name="gender" value="perempuan" class="w-4 h-4 text-indigo-600 focus:ring-indigo-500">
            ...
            <div>
                ...
                <textarea name="address" rows="3" class="w-full border border-slate-200 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all" placeholder="Alamat lengkap..." required></textarea>
            </div>
